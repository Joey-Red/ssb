...
export function FrameDataPanel({ data }: { data: FighterFrameData }) {
  ...
  return (
    <section className="panel frame-data-panel" aria-labelledby="frame-data-title">
      ...
      <p className="frame-data-footnote">Raw factual notation is preserved for ranges, multi-hits and early/late values. Total frames and FAF are separate fields. The visual player only draws hitbox regions when the exact frame has overlay metadata; missing geometry remains missing rather than guessed.</p>
    </section>
  )
}
