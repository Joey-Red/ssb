...
export function FrameDataPanel({ data }: { data: FighterFrameData }) {
  ...
  return (
    <section className="panel frame-data-panel" aria-labelledby="frame-data-title">
      ...
      <p className="frame-data-footnote">Raw factual notation is preserved for ranges, multi-hits and early/late values. Total frames and FAF are separate fields; this app never substitutes one for the other.</p>
    </section>
  )
}
